...
class FernDrawer:
    def __init__(self, renderer, depth=7):
        ...
        # Une branche ressemble à peu près à cela:
        #   *
        #   |/
        #  \|
        #   |/
    ...
    def turn(self):
        """Rotation. Comme left(80) ou right(80) du turtle,
        selon l'état de flip."""
        self.renderer.turn(80 if self.flipped else -80)

    def push(self):
        """Enregistre l'état actuel du "stylo" pour le placer sur la pile."""
        self.renderer.push()
